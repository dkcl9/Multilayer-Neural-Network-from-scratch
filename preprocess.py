...
def main():
    ...
    train_label_file = 'data_prog2Spring24/labels/train_label.txt'
    train_indir = 'data_prog2Spring24/train_data/'
    train_outdir = 'data_prog2Spring24/train_processed/'
    train_csv_file = 'data_prog2Spring24/labels/train_anno.csv'

    preprocess_data(csvfile=train_csv_file, image_dir=train_indir, process_dir=train_outdir,
                    label_file=train_label_file)

    print("Preprocessing Testing Data")
    test_label_file = 'data_prog2Spring24/labels/test_label.txt'
    test_indir = 'data_prog2Spring24/test_data/'
    test_outdir = 'data_prog2Spring24/test_processed/'
    test_csv_file = 'data_prog2Spring24/labels/test_anno.csv'
